    ...
    <div className="h-full flex flex-col p-4 text-gray-300 gap-4 font-sans overflow-hidden">
      ...
      <div className="shrink-0 space-y-3 pt-2 border-t border-gray-800">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <ToolBadge icon={<svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" /></svg>} label={t.TOOL_VOICE} isActive={activeProcess === 'TOOL_TTS'} color="yellow" />
          </div>
          <div className="grid grid-cols-2 gap-2">
            <button onClick={toggleAutoMode} className={`flex items-center justify-between px-3 py-2 rounded-lg border transition-all ${isAutoMode ? 'bg-pink-900/20 border-pink-700/50' : 'bg-[#21262d] border-gray-700'}`}>
