...
export const AIProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <AIContext.Provider value={{
      ...
      isAutoMode, isSubmitting, isApiKeyNeeded, isQuotaExhausted, isImageGenerationPaused, isImageQuotaExhausted,
      ...
      setLanguage, toggleAutoMode, toggleImageGenerationPause, 
      ...
      latestMessagesRef, latestStatusRef, latestIsImageGenerationPausedRef,
